  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
      <header className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <ShareBox inviteCode={overview.pool.inviteCode} shareUrl={shareUrl} />
      </header>
...
function ShareBox({ inviteCode, shareUrl }: { inviteCode: string; shareUrl: string }) {
      ...
      <button
        onClick={async () => {
          try {
            ...
            /* clipboard unavailable — code is visible above regardless */
          }
        }}
        className="mt-1 text-xs text-pitch underline"
      >
